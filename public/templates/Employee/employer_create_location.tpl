                            ...
                            <div class="sixteen wide tablet sixteen wide computer column">
                                <div class="ui left aligned segment">
                                    <table class="ui compact selectable striped celled table tablet stackable dataTable no-footer">
                                        ...
                                        <tr>
                                            <td>{$location.id}</td>
                                            <td>{$location.street} {$location.hsnr}<br>{$location.zip} {$location.city}<br>{$location.country}</td>
                                        </tr>
                                        {endfor}
                                        </tbody>
                                    </table>
                                    <form method="post" action="{$base}login" class="ui form">
                                        ...
                                        <br>
                                        <button class="ui teal right labeled icon button fluid" type="submit">{L_create}<i class="icon save"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
