                        ...
                        <div class="row">
                            <div class="sixteen wide tablet six wide computer column">
                                <div class="ui left aligned segment">
                                    <div class="ui attached message inverted blueli">
                                        <div class="header">
                                            {L_register_descr}
                                    </div>
                                    <form class="ui form" action="{$base}register" method="post">
                                        ...
                                        <div class="two fields">
                                            <div class="field">
                                                <label>{L_iban}</label>
                                                <input type="text" name="iban" placeholder="{L_iban}" required>
                                            </div>
                                            <div class="field">
                                                <label>{L_bic}</label>
                                                <input type="text" name="bic" placeholder="{L_bic}" required>
                                            </div>
                                        </div>
                                        <div class="two fields">
                                            <div class="field">
                                                <label>{L_company}</label>
                                                <input type="text" name="company" placeholder="{L_company}">
                                            </div>
                                            <div class="field">
                                                <label>{L_tel}</label>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="ui fluid search selection scrolling dropdown">
                                                ...
                                                <div class="default text">{L_choose_country}</div>
                                                <div class="menu">
                                        ...
                                        <br>
                                        <button class="ui teal right labeled icon button fluid" type="submit">{L_sign_up}<i class="icon signup"></i></button>
                                        <a class="ui blue right labeled icon button fluid" href="login">{L_sign_in}<i class="icon sign in"></i></a>
                                    </form>
                                    {$error}
                                </div>
                            </div>
