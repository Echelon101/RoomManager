    ...
    <div class="pusher">
        ...
        <div class="mainWrap">
            ...
            <div class="ui equal width center aligned padded grid stackable">
                <!--Site Content-->
                <div class="ui width padded centered grid ">
...
<p>Wir informieren Sie nachfolgend gemäß den gesetzlichen Vorgaben des Datenschutzrechts (insb. gemäß BDSG n.F. und der europäischen Datenschutz-Grundverordnung ‚DS-GVO‘) über die Art, den Umfang und Zweck der Verarbeitung personenbezogener Daten durch unser Unternehmen. Diese Datenschutzerklärung gilt auch für unsere Websites und Sozial-Media-Profile. Bezüglich der Definition von Begriffen wie etwa „personenbezogene Daten“ oder „Verarbeitung“ verweisen wir auf Art. 4 DS-GVO.</p>
					...
					<br />Private Storage GmbH<br />Am Zwinger 14<br />33602 Bielefeld DE<br />E-Mail-Adresse: webmaster@privatestorage.de<br /><br /><strong>Datenarten, Zwecke der Verarbeitung und Kategorien betroffener Personen</strong><br />
        ...
        <br />
        <strong>2. Zwecke der Verarbeitung nach Art. 13 Abs. 1 c) DS-GVO</strong><br />Abwicklung von Verträgen, Website technisch und wirtschaftlich optimieren, Erfüllung vertraglicher Verpflichtungen, Kommerzielle Nutzung der Website unterstützen, Erstellung von Statistiken, Websites mit Funktionen und Inhalten bereitstellen, Unterbrechungsfreier,sicherer Betrieb unserer Website, <br />
        <br />
        ...
        <ol style="margin:10px 0px; padding:15px;">
			...
			<ol style="margin:10px 0px; padding:15px;">
				...
				<li>Der Gerätecache speichert die Anrufe 30 Tage und überschreibt bzw. löscht sukzessiv alte Daten, bei Entsorgung des Gerätes werden alle Daten gelöscht und der Speicher ggf. zerstört. Gesperrte Telefonnummer werden jährlich auf die Notwendigkeit der Sperrung geprüft.<br/><br/></li>
        ...
        <ol style="margin:10px 0px; padding:15px;">
            <li><strong>Widerspruch oder Widerruf gegen die Verarbeitung Ihrer Daten<br /><br />
                ...
                Sie können der Verarbeitung Ihrer personenbezogenen Daten für Zwecke der Werbung und Datenanalyse jederzeit widersprechen. Das Widerspruchsrecht können Sie kostenfrei ausüben. Über Ihren Werbewiderspruch können Sie uns unter folgenden Kontaktdaten informieren:<br /><br />Private Storage GmbH<br />Am Zwinger 14<br />33602 Bielefeld DE<br />E-Mail-Adresse: webmaster@privatestorage.de<br /></strong>
                	<br /></li>
					...
					<br/>
					<strong>Stand: 17.01.2019</strong><p>Quelle: <a href="https://www.juraforum.de/impressum-generator/">Muster-Datenschutzerklärung von JuraForum.de</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
